...
const ACCOUNT_HEAD_RULES: RefRule[] = [
  ...
  { model: "VoucherAdjustment", columns: ["accountHeadId"], label: "voucher adjustments", extraWhere: { voucher: { deletedAt: null } } },
...
const PARTY_RULES: RefRule[] = [
  ...
  { model: "ShortageEntry", columns: ["partyId"], label: "shortage entries", soft: SOFT },
  { model: "ShortageRecovery", columns: ["partyId"], label: "shortage recoveries", extraWhere: { shortage: { deletedAt: null } } },
...
const VEHICLE_RULES: RefRule[] = [
  ...
  { model: "VehicleExpenseItem", columns: ["vehicleId"], label: "vehicle expense items", extraWhere: { voucher: { deletedAt: null } } },
  ...
  { model: "DriverAssignment", columns: ["vehicleId"], label: "driver assignments", extraWhere: { driver: { deletedAt: null } } },
